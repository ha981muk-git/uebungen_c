...
struct node * newElement(char * vorname, char * nachname, char * beruf, int tischNr, struct node * vorherigesElement) {
    ...
    hilfsZeiger->teiln.tischNr = tischNr;
...
int main() {
    ...
    aktuellerZeiger = newElement("Rudi", "Rohrbruch", "Wasserinstallateur", (rand() % ANZTISCHE) + 1, aktuellerZeiger);    
